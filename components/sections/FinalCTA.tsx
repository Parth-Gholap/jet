...
export default function FinalCTA() {
  return (
    <section className="relative w-full py-40 bg-brand-bg flex items-center justify-center overflow-hidden" id="reserve">
      
      {/* Background glow & gradient */}
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[100vw] h-[50vh] bg-gradient-to-t from-brand-accent/20 to-transparent" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] bg-brand-accent/5 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <motion.p 
          ...
          className="text-brand-accent text-xs tracking-[0.3em] uppercase mb-8 font-mono"
        >
