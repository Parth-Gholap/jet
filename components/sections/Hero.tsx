    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col md:flex-row h-full">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-transparent -z-10 -ml-12 w-[150%]" />
          ...
          >
            ...
            <p className="text-white/70 text-lg md:text-xl max-w-xl font-light leading-relaxed mb-10 drop-shadow-lg">
            ...
            <div className="flex flex-wrap gap-6 items-center mb-16">
              ...
              <button className="group flex items-center gap-4 px-6 py-4 text-xs tracking-widest uppercase font-medium hover:text-white transition-colors text-white/70">
                <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:border-white/50 group-hover:bg-white/5 transition-all">
            ...
            <div className="grid grid-cols-3 gap-8 border-t border-white/10 pt-8 max-w-xl">
              ...
              <div>
                ...
                <p className="font-serif text-2xl text-white">Mach 0.95</p>
              </div>
              <div>
        ...
        >
          ...
          >
            <Image 
              ...
              className="object-contain object-right drop-shadow-[0_0_100px_rgba(41,93,255,0.2)]"
              priority
            />
