...
export default function AircraftDeconstruction() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full bg-brand-bg overflow-hidden" id="engineering">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-6">
        ...
        >
          <p className="text-brand-accent text-xs tracking-[0.3em] uppercase mb-4 font-mono font-bold drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
            Acoustic Isolation
          </p>
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-6xl lg:text-8xl tracking-tight text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.9)] leading-tight mb-6">
            ...
            <span className="text-brand-accent italic font-light drop-shadow-[0_0_20px_rgba(41,93,255,0.4)]">Aerospace Intelligence.</span>
          </h2>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 pointer-events-auto">
            <button className="rounded-full bg-brand-accent text-white px-10 py-5 text-xs tracking-widest uppercase font-bold hover:bg-white hover:text-black hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all duration-300">
              Build Your X1
            </button>
            <button className="rounded-full glass-accent px-10 py-5 text-xs tracking-widest uppercase font-medium hover:bg-brand-accent/20 transition-all border border-brand-accent/50 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
              View Specifications
            </button>
          </div>
        </div>
